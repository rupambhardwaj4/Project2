...
def settings_page(request):
    if request.method == "POST":
        ...
        mapping = {
            ...
            "applySignatureToInvoice": "apply_signature_to_invoice",
            "applySignatureToSalarySlip": "apply_signature_to_salary_slip",
            "applySealToInvoice": "apply_seal_to_invoice",
            "applySealToSalarySlip": "apply_seal_to_salary_slip",
